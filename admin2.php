            ...
            <div class="section__content section__content--p30">
               <div class="container-fluid">
                  <div class="header-wrap">
                     <h1>Absensi SMPN 3 Bangkinang</h1>
            ...
            <div class="section__content section__content--p30">
               <div class="container-fluid">
                  <div class="row d-flex jsutify-content-center">
                     <strong class="col-md-12" style="margin: 2rem;">Selamat Datang Admin!!</strong>
                     <div style="width: 100%;display:flex;justify-content:center" >

                        <img src="images/logosmp.jpg" width="500" class="img img-responsive" height="500">
                     </div>
