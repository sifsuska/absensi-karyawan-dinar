  ...
  <head>
    ...
    <title>Absensi Karyawan - Home</title>
        ...
        <div class="container content-wrapper">
          <div class="row align-items-center">
            <div class="col-md-4 text-center text-md-left">
              <img src="img/pp.png" class="img-fluid" alt="Logo">
            </div>
            <div class="col-md-8">
              <h1 class="mb-2">Website Absensi SMPN 3 Bangkinang</h1>
              <p class="text-center">Website ini berfungsi sebagai absensi pegawai dan sebagai sistem informasi pegawai.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                  ...
                  <p class="card-feature__subtitle">Dinar Maulana Khannafi</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                  ...
                  <p class="card-feature__subtitle">0813-1067-3807</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                  ...
                  <p class="card-feature__subtitle">@dinarmaulana_</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer class="footer-area section-gap">
        ...
        <div class="footer-bottom row align-items-center text-center text-lg-left">
          <p class="footer-text m-0 col-lg-8 col-md-12"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            ...
            </script> Merry Anjani All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
