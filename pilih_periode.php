            ...
            <div class="section__content section__content--p30">
               <div class="container-fluid">
                  ...
                  <div class="row">
                     ...
                     <form action="report_absensi.php" method="post">
                        <div class="form-group">
                           ...
                           <table class="table table-borderless table-striped table-earning">
                              ...
                              <tbody>
                                       ...
                                       <select class="form-control" name="bln">
                                          ...
                                          <?php
                                                   ...
                                                   for($c=0; $c<$jlh_bln; $c+=1){
                                                      ...
                                                      echo"<option value=$g> $bulan[$c] </option>";
                                                   }
                                          ?>
                                       </select>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <select class="form-control" name="id_karyawan">
                                          <option value="">Tampilkan Semua Pegawai</option>
                                          <?php 
                                            include 'koneksi.php';
                                         ...
                                         ?>
                                          <option value='<?php echo $row['id_karyawan'] ?>'> <?php echo$row['nama'] ?>
                                          </option>
                                          <?php
                                          }
                                          ?>
                                 ...
                                 <tr>
                                    <td></td>
                                    <td><button type="submit" name="simpan" class="btn btn-primary mr-2">Cari
                                          Laporan</button>
