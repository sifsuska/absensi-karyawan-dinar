               ...
               <ul class="navbar-mobile__list list-unstyled">
                  ...
                  <li>
                     <a href="pilih_periode.php">
                        <i class="fas fa-table"></i>Laporan Absensi</a>
                  </li>
                  ...
                  <div class="header-wrap">
                     ...
                     <form class="form-header" action="prospenkar.php" method="POST">
                        <input class="au-input au-input--xl" autocomplete="off" type="text" name="cari"
                           placeholder="Cari No ID atau Nama Pegawai" />
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          <input type="text" class="form-control" maxlength="18" required=""
                                             name="id_karyawan" autocomplete="off" size="25px" maxlength="25px">
                                    ...
                                    <tr>
                                       <td>Nama</td>
                                       <td><input type="text" class="form-control" required="" name="nama"
                                             autocomplete="off"></td>
                                    </tr>
                                    <tr>
                                       <td>Tempat dan Tanggal Lahir</td>
                                       <td><input type="text" class="form-control" required="" name="tmp_tgl_lahir"
                                             autocomplete="off"></td>
                                    </tr>
                                    <tr>
                                       <td>Jenis Kelamin</td>
                                    ...
                                    <tr>
                                       <td>Alamat</td>
                                       <td><textarea class="form-control" required="" name="alamat"
                                             autocomplete="off"></textarea> </td>
                                    </tr>
                                    <tr>
                                       <td>No Telepon</td>
                                       <td><input type="text" autocomplete="off" maxlength="18" required=""
                                             class="form-control" name="no_tel"></td>
                                    </tr>
                                    <tr>
                                       <td>Jabatan</td>
                                       <td>
                                    ...
                                    <tr>
                                       <td><button type="submit" name="simpan" class="btn btn-primary">Simpan</button>
                                       </td>
